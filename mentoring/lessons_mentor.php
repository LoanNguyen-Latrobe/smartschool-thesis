									...
									<table class="table table-hover table-center mb-0">
										...
										<tbody>
											<tr>
												...
												<td>
		                      						<a href="lessons_detail_mentor.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-eye-open"></span></a> | <button class="btn btn-sm btn-danger btn_remove" type="button" id=""><span class="glyphicon glyphicon-trash"></span></button>
												</td>
											</tr>
											<tr>
												<td>2</td>
